<nav class="bg-slate-50 font-serif">
  <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-12 pb-3">
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        <div class="mx-5">
          <a href="/login" class="bg-amber-400 p-3 rounded-xl hover:bg-gray-700 hover:text-white" >Login</a>
        </div>
  ...
  {{-- <div class="sm:hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pb-3 pt-2"> --}}
      ...
      {{-- <a href="#" class="text-neutral-800 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Team</a>
